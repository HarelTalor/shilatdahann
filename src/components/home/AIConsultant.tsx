    ...
    <section className="py-24 bg-interesting-luxury border-t border-border/50 overflow-hidden relative">
      ...
      <div className="container px-4 mx-auto max-w-4xl relative">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <h2 className="text-2xl md:text-4xl font-serif font-bold text-heading">היועצת האישית של שילת דהן</h2>
          <Sparkles className="text-secondary" size={24} />
        </div>
            ...
            {!isFinished ? (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-2">
                  <p className="text-secondary font-medium">שלב {currentStep + 1} מתוך {steps.length}</p>
              ...
              <div className="space-y-8 animate-in fade-in zoom-in duration-500">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  <Button size="lg" className="rounded-full px-10 h-14 text-lg font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform" asChild>
                    <a href={`https://wa.me/972500000000?text=היי שילת, היועצת בוט המליצה לי על ${getRecommendation().title}, אשמח לשמוע עוד.`} target="_blank" rel="noreferrer">
