...
import imgPigment from "@/assets/pigmentation_treatment.png";
import imgAntiAging from "@/assets/anti_aging.png";
import imgAcne from "@/assets/acne_treatment.png";

const treatmentPreviews = [
  {
    title: "טיפול בפיגמנטציה והבהרה",
    description: "טיפול אינטנסיבי להבהרת כתמים, איחוד גוון העור והענקת מראה זוהר.",
    image: imgPigment,
  },
  {
    title: "אנטי-אייג'ינג וחידוש",
    description: "שימוש בחומרים פעילים למיצוק, טשטוש קמטים וחידוש התאים.",
    image: imgAntiAging,
  },
  {
    title: "אקנה ופוסט-אקנה",
    description: "טיפול רפואי ממוקד לריפוי אקנה ושיקום מרקם העור.",
    image: imgAcne,
  },
];
      ...
      <div className="container px-4 mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-heading tracking-tight uppercase-hebrew">הטיפולים הנבחרים שלנו</h2>
